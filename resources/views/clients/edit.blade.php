...
<div class="max-w-xl">
    <h1 class="text-2xl font-semibold text-gray-800 mb-6">Edit Client</h1>
        ...
        <form method="POST" action="{{ route('clients.update', $client) }}">
            ...
            <div class="mb-6">
                ...
                <textarea name="address" rows="3"
                          class="w-full border rounded-lg px-3 py-2 text-sm border-gray-300">{{ old('address', $client->address) }}</textarea>
            </div>
